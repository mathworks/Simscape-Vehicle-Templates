...
%% Model
%
% <matlab:open_system('testrig_susp_linkage'); Open Model>
 
open_system('testrig_susp_linkage')
ann_h = find_system('testrig_susp_linkage','FindAll', 'on','type','annotation','Tag','ModelFeatures');
...
Vehicle = sm_car_vehcfg_setPeopleOnOff(Vehicle,[0 0 0 0 0],'SuspA1');
Maneuver = sm_car_maneuverdata_knc(0.1,-0.1,0.01,1.0,0.10,500,1200,1200);
...
Vehicle = sm_car_vehcfg_setPeopleOnOff(Vehicle,[0 0 0 0 0],'SuspA1');
Maneuver = sm_car_maneuverdata_knc(0.05,-0.03,0.01,1.3,0.03,500,1200,1200);
