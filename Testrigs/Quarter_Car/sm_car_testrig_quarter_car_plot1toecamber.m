...
simlog_pxTire        = out.simlog_sm_car_testrig_quarter_car.Actuator.Cartesian_Joint.Px.p.series.values('m');
simlog_pyTire        = out.simlog_sm_car_testrig_quarter_car.Actuator.Cartesian_Joint.Py.p.series.values('m');
...
simlog_rigFz         = squeeze(out.logsout_sm_car_testrig_quarter_car.get('Fz').Values.Data);
simlog_fBumpstop     = squeeze(out.logsout_sm_car_testrig_quarter_car.get('Damper').Values.FBumpstop.Data);
if(isfield(out.logsout_sm_car_testrig_quarter_car.get('Linkage').Values,'Shock'))
    simlog_xSpring       = squeeze(out.logsout_sm_car_testrig_quarter_car.get('Linkage').Values.Shock.x.Data);
else
    simlog_xSpring       = squeeze(out.logsout_sm_car_testrig_quarter_car.get('Spring').Values.xSpring.Data);
end
