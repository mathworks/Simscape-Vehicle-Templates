...
%
blkStruct.Name = ['Simscape Multibody Parts Library'];
%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'Multibody_Parts_Lib';
...
%
blkStruct.MaskDisplay = 'Simscape Multibody Parts Library';
...
Browser(1).Library = 'Multibody_Parts_Lib';
Browser(1).Name    = 'Simscape Multibody Parts Library';
