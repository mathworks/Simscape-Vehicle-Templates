function scene_data = sm_car_scenedata_gsd(varargin)
% The code below adds the default set of grid surface data to the Scene
% database. This is mainly for testing purposes, as the Infinite Plane
% would be a better way to model this.  
%
...
% **Note** - This scene name is referenced in the block libraries and
%            should not be changed.  Other grid surface data will be
%            copied into Scene.GS_Grid_Surface field to change surfaces.
%            This data is referenced by Scene and tires in model.
scene_data.Name     = 'GS_Grid_Surface';
