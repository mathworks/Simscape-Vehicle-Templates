function maneuver_data = sm_car_maneuverdata_elk_test

maneuver_type = 'Elk_Test';
...
sm_car_trajectory_elk_test(false)
...
for i=1:length(Instance_List)
    ...
    mdata.(Instance).Trajectory_LoadFile.Value    = 'Elk_Test_trajectory_default.mat';
