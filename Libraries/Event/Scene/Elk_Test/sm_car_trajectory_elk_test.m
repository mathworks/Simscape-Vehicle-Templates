function sm_car_trajectory_elk_test(showPlot)
% Function to construct double-lane change maneuver for elk test
...
save Elk_Test_trajectory_default x y z vx aYaw xTrajectory 
