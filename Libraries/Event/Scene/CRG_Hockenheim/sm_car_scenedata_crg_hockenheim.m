...
scene_data.Name               = 'CRG_Hockenheim';
scene_data.CRGfile            = 'CRG_Hockenheim.crg';
scene_data.Geometry.filename  = 'CRG_Hockenheim.stl';
...
scene_data.Geometry.centerline.filename  = 'CRG_Hockenheim_centerline.stl';
