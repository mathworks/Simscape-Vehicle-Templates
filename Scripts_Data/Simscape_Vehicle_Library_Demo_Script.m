...
% <td><b>CRG Slope</b> </td>
% <td><a href="matlab:cd(fileparts(which('sm_car_scene_crg_slope.slx')));open_system('sm_car_scene_crg_slope.slx')">Library</a></td>
% <td><a href="matlab:cd(fileparts(which('sm_car_scenedata_crg_slope.m')));edit sm_car_scenedata_crg_slope.m;">Data</a></td></tr>
...
% <td><a href="matlab:sm_car_plot_maneuver(MDatabase.Double_Lane_Change.default);">Plot Trajectory</a></td></tr>
...
% <td>Plot Trajectory: <a href="matlab:sm_car_plot_maneuver(MDatabase.Mallory_Park.default);">Clockwise</a>, <a href="matlab:sm_car_plot_maneuver(MDatabase.Mallory_Park.CCW);">Counterclockwise</a></td></tr>
% </table><br>
% <br>
