...
set_param(mdlTestrig,'PostLoadFcn','Vehicle_data_dwpullrod;Maneuver = sm_car_maneuverdata_knc(0.05,-0.03,0.01,1.3,0.03,500,1200,1200,1200,1200,-0.3);')
save_system(mdlTestrig)
bdclose(mdlTestrig)

mdlTestrig = 'testrig_quarter_car_doublewishbone';
load_system(mdlTestrig)
set_param(mdlTestrig,'PostLoadFcn','Vehicle_data_dwishbone;Maneuver = sm_car_maneuverdata_knc(0.17,-0.21,0.01,1.3,0.1,500,1200,1200,1200,1200,-0.3);')
save_system(mdlTestrig)
bdclose(mdlTestrig)
