...
append_line_to_script('Vehicle_data_decoupled.m','% Set derived fileds from within Vehicle data structure')
append_line_to_script('Vehicle_data_dwishbone.m','% Set derived fileds from within Vehicle data structure')
...
set_param([mdl_2 '/World'],'popup_scene','CRG Hockenheim');
...
doNotCopyList_SLX = {...
    ...
    '\Libraries\Vehicle\Tire\CFL_Libs\',...
