function CarMetricsSet = sm_car_sweep_plot_runs_strfrc(simInput,simOut,metricName,tTrans)
...
for r_i = 1:numTests
    ...
    [CarMetrics] = sm_car_perf_metrics_strfrc(simOut(r_i).logsout_sm_car,simOut(r_i).simlog_sm_car,Vehicle,tTrans);
