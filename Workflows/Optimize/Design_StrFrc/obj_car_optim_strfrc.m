function F  = obj_car_optim_strfrc(x,mdl,par_list,Vehicle,metricName,tgtValue,metricWeights,simResStr,h_simRes)
...
CarMetrics = sm_car_perf_metrics_strfrc(simOut.logsout_sm_car,false,true,false);
