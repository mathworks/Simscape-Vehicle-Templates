...
sim_tStr_mech = sm_car_sim_res_get(logsout_sm_car,simlog_sm_car,Vehicle,'tSteer');
...
sim_tStr_vStr = sm_car_sim_res_get(logsout_sm_car,simlog_sm_car,Vehicle,'tSteer');

% Enable steer-by-wire with electrical actuator
...
sim_tStr_sBwr = sm_car_sim_res_get(logsout_sm_car,simlog_sm_car,Vehicle,'tSteer');
...
figure(97)
plot(sim_time_mech.data, sim_tStr_mech.data,'LineWidth', 1,'DisplayName','Mechanical');
hold on
plot(sim_time_vStr.data, sim_tStr_vStr.data,'LineWidth', 1,'DisplayName','Steer By Wire, Ideal');
plot(sim_time_sBwr.data, sim_tStr_sBwr.data,'LineWidth', 1,'DisplayName','Steer By Wire, Electric');
hold off
grid on
